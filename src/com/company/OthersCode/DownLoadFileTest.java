...
//    }
//
//    public DownLoadFileTest(Context mContext, String loadUrl, String filePath) {
//        this(mContext, loadUrl, filePath, DEFAULT_THREAD_COUNT, null);
//    }
//
//    public DownLoadFileTest(Context mContext, String loadUrl, String filePath, DownLoadListener mDownLoadListener) {
//        this(mContext, loadUrl, filePath, DEFAULT_THREAD_COUNT, mDownLoadListener);
//    }
//
//    public DownLoadFileTest(Context mContext, String loadUrl, String filePath, int threadCount) {
...
//     */
//    public DownLoadFileTest(Context mContext, String loadUrl, String filePath, int threadCount, DownLoadListener mDownLoadListener) {
...
//                        for (int i = 0; i < threadCount; i++) {//TODO:一个for循环
...
//                HttpURLConnection conn = (HttpURLConnection) url.openConnection();
//                conn.setRequestMethod("GET");
//                conn.setRequestProperty("Range", "bytes=" + startPosition + "-" + endPosition);//TODO:
//                conn.setConnectTimeout(5000);
